...
public class E2EScenariosBEStepDefs {
    ...
    // This value needs to be updated after each run
    public String responseTypeValue = "code";
    public String grantTypeValue = "authorization_code";
    public String biometricSessionIdValue = "a8ca9ea2-27c0-4062-8e22-0d9258c8b988"; //value for INT

    @Given("the verifyAuthorize request session is posted")
    public void theVerifyAuthorizeRequestSessionIsPosted() {
        RestAssured.baseURI = ConfigurationReader.get("APIInt");
        RestAssured.given()
                .accept(ContentType.JSON)
                .queryParam("client_id", ConfigurationReader.get("clientIdInt"))
